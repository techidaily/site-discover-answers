---
title: "Download PCDJ's Latest Karaoke Software: Lyrx v1.2 Available for Mac Users!"
date: 2025-01-18T23:09:37.388Z
updated: 2025-01-23T18:43:33.930Z
tags:
  - product
categories:
  - pcdj
...
## Download PCDJ's Latest Karaoke Software: Lyrx v1.2 Available for Mac Users!

**LYRX is the ultimate karaoke software for MAC and it just got _a lot better_ with the release of version 1.2!**

![LYRX Karaoke software for MAC v1.2](https://i1.wp.com/pcdj.com/wp-content/uploads/2018/03/MacBook_Pro_main-top-image.png?fit=300%2C194&ssl=1 "LYRX Karaoke software for MAC v1.2")

LYRX version 1.2 is ready for download below. A free update for all owners of LYRX, the new 1.2 release includes a large helping of new professional-level karaoke show hosting features.

Version 1.2 includes a new managed singer rotation list, singer/song history, automatic filler music player, and a few new karaoke-specific settings in options (these new features are covered in the overview video above). Version 1.2 is considered a major upgrade and the new professional-level karaoke features mean whether your a home user or a karaoke host that manages 50+ singers a karaoke night LYRX is ready to perform.

Also included are various new ease-of-use items and support for all various zip formats.
...
### What’s New, Changed, and Updated in LYRX Version 1.2
...
* Karaoke Singers Rotation list is the default list in LYRX;
...
* Background music player / filler player for karaoke
...
* The filler player works automatically:  
– it starts/stops gracefully (fade in/out) when one of the decks is paused/playing  
– you can activate and deactivate it using the small Play button (in the case/preview player)
* LYRX default skin completely redone (redrawn) to add the new Karaoke Singers Rotation list functionality
* LYRX new skin included
...
[UPDATE LYRX NOW](https://tools.techidaily.com/pcdj/products/)

[DOWNLOAD FREE TRIAL](http://lyrxkaraoke.com/free-trial-2/)

_**UPDATE INSTRUCTIONS:** Download and install version 1.2 with your existing version closed to update automatically (install over-top)_
...
https://i0.wp.com/pcdj.com/wp-content/uploads/2018/03/LYRXV12UPDATE-template.jpg?fit=706%2C360&ssl=1 360 706 Ryan Sherr https://www.pcdj.com/wp-content/uploads/2021/07/pcdj-main-logo-2.png Ryan Sherr2018-03-16 12:47:182018-10-02 12:56:45Karaoke Software for MAC | LYRX Version 1.2 is Ready for Download!}
